...
// This is the GraphQL query that defines all the cart data we need.
...
// POST function to create or update a cart
export async function POST({ request }) {
    ...
    if (action === 'create') {
        ...
        const query = `mutation addToCart($cartId: ID!, $lines: [CartLineInput!]!) { cartLinesAdd(cartId: $cartId, lines: $lines) { cart { ${CART_QUERY_FRAGMENT} } } }`;
